package petGame;
/**
 * This class implements the Poney. 
 * This Constructs three basic actions of the pet which are eat, play, sleep. 
 * @author sly31 & mxu19
 * @version 1.0
 */
public class Poney extends Pets{

	public Poney() {
		super();
		describe = "1.Need more time to eat, hard to get sick and get tired\n2. Likes [Nice Grass] and [Carrot Rob]";
		getImg = "/petGame/icons/Poney.png";
	}
	 ...
	 * @param tried are decreasing 3 by the next day.
	 * @param hungry decreasing 25 by next day.
	 * @param fun decreasing 15 by next day.
	 * @param toilet decreasing 15 by next day.
	 * @param weight is increasing 15 by next Day.
	 */
