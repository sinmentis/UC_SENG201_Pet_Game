...
public class Cat extends Pets{
	public Cat() {
		super();
		describe = "1.Need more time to sleep, hard to get sick\n2. Likes [CatMint] and [Fake Mouse]";
		getImg = "/petGame/icons/Cat.png";
	}
	...
	public void sleep(){
		this.health += 15; // sleep increase health
		this.tried += 5;
		this.hungry -= 15;
		this.fun -= 10;
	}
